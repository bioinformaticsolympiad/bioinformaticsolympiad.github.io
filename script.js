...
function initRegistrationCountdown() {
    const deadline = new Date('2026-07-29T23:59:59+06:00');
...
function initChatbot() {
    ...
    const knowledgeBase = [
        ...
        { keywords: ['date', 'when', 'schedule', 'day', 'deadline', 'july'], answer: 'The registration deadline is <strong>29 July 2026 at 11:59 PM (BST)</strong>. Round 1 will be held on <strong>31 July 2026</strong>. The Round 2 final date will be announced later.' },
        { keywords: ['mode', 'hybrid', 'online', 'offline', 'platform', 'meet', 'testmoz', 'livemcq', 'venue'], answer: 'Round 1 is a free online screening round through Google Meet, TestMoz, and LiveMCQ, covering Botany and Zoology. Round 1 is on <strong>31 July 2026</strong>. Round 2 is an advanced campus round at the <strong>University of Chittagong (CU)</strong>; its date will be announced later.' },
        ...
        { keywords: ['syllabus', 'topic', 'topics', 'prepare', 'study', 'subject'], answer: 'Round 1 covers Botany and Zoology at an early-year undergraduate level. Round 2 covers Basic Biochemistry, Cell Biology, Molecular Biology & Genetics, Genetic Engineering & Biotechnology, Microbiology & Immunology, Bioinformatics & Applied AI, Pharmacy, Botany, Zoology, Chemistry, Agriculture & Environmental Science, Public Health, Fisheries, and Scientific History & General Knowledge.' },
    ...
    const fallbackAnswers = [
        'I can help with the 29 July deadline, 31 July Round 1 exam, Round 2 syllabus, registration link, rules, prizes, eligibility, or platforms. Try asking: "What is in the syllabus?"',
        'Good question. For official confirmation, check the relevant website section or contact BioPC.',
        'I may not have that exact detail yet. Ask about the syllabus, Round 1 date, registration deadline, final venue, or internship prizes.'
    ];
